               ...
               <div class="row">
                  <div class="col-sm-3">
                     <div class="card iq-mb-3">
                        <img src="<?php echo base_url('assets/images/page-img/07.jpg') ?>" class="card-img-top" alt="#">
                        <div class="card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="card bg-dark text-white iq-mb-3">
                        <img src="<?php echo base_url('assets/images/page-img/07.jpg') ?>" class="card-img" alt="#">
