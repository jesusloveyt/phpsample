...
?>
            ...
            <div class="col-md-9">
                <form action="<?php echo base_url('index.php/appointment-update-data') ?>" method="POST" class="text-center" id="form-wizard1" />
                    <input type="hidden" name="id" value=" <?php echo isset($d->id) ? $d->id :'';?>" />
                                        <!-- fieldsets -->
                        <fieldset>
                                ...
                                <div class="row"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" id="category" class="select2js form-control"  required>
                                                ...
                                                <?php foreach($category as $cat) {?>
                                                    <option value="<?php echo $cat->id;?>" <?php if($cat->id == isset($d->category_id) ? $d->category_id: '' ) echo 'selected="selected"'; ?> > <?php echo $cat->name; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="service_id" id="service_id" class ="select2js form-control">
                                            <?php if(isset($d->service_id)){ ?>
                                                    <option value="<?php echo $d->service_id ?>" selected > <?php echo isset($d->service_id ) ? $d->sname : "" ?></option>
                                            <?php }?>
                                            </select>
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" step = 'any' class = 'form-control' id="price" value='<?php echo isset($d->price)? $d->price :'';?>'/>
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date" class="form-control datepicker" value="<?php echo isset($d->date) ? $d->date :''; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label">Time <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control timepicker" name="time" value="<?php echo isset($d->time) ? $d->time :'' ?>" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 new_customer">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="user_id" value="<?php echo isset($d->name) ? $d->name :''?>"  class="form-control">
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 new_customer">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" value="<?php echo isset($d->email) ? $d->email :'';?>" class="form-control">
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 new_customer">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact_number"  value="<?php echo isset($d->contact_number) ? $d->contact_number :'';?>" class="form-control">
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                                    </div>
                                </div>
