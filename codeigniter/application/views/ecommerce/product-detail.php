                              ...
                              <div class="col-md-6 iq-item-product-left">
                                 <div class="iq-image-container">
                                    <div class="iq-product-cover">
                                       <img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid">
                                    </div>
                                    <div class="iq-additional_slider">
                                       <ul id="product-additional-slider" class="d-flex m-0 p-0">
                                          <li><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid"></li>
                                          <li><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid"></li>
                                          <li><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid"></li>
                                          <li><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid"></li>
                                          <li><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid"></li>
                                       ...
                                       <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                          <div class="product-miniature">
                                             <div class="thumbnail-container">
                                                <a href="#"><img src=<?php echo base_url("assets/images/index.jpeg")?> alt="product-image" class="img-fluid" /> </a>                                             
                                             </div>
